          ...
          <div className="rowDetails">
            <div>
              <div className="textDetails">
                <h2>"HARD SKILLS CONTRATAM,<br /> SOFT SKILLS DEMITEM"</h2>
                <p>
                  O lema é perfeito. Mas a prática não é fácil. <br/>O mercado tem
                  mais ferramentas e capacidade de avaliar as verdadeiras
                  habilidades técnicas de um profissional. Nosso trabalho é
            ...
            <div className="dashboard">
              ...
              <img src={Dash2} className="dashboard2" />
              <img src={Dash3} className="dashboard3" />
              <img src={Dash4} className="dashboard4" />
            </div>
          </div>
        </div>
      </section>
